...
- explicit free-text reasons control promotion; for example, `reseller hardware and equipment buys are not a target fit` should learn caution on that work pattern, not broad cautions against data management, set-aside posture, or prime-possible posture
