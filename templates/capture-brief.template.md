...
**Canonical Record ID Type:** {{CANONICAL_RECORD_ID_TYPE}}  
**Notice ID:** {{NOTICE_ID_OR_NA}}  
**Request ID:** {{REQUEST_ID}}  
**Research Status:** {{RESEARCH_STATUS}}  
**Primary Source:** {{PRIMARY_SOURCE}}  
**Primary Source Tier:** {{PRIMARY_SOURCE_TIER}}  
**Brief Path:** {{REQUEST_CAPTURE_BRIEF_PATH}}  
